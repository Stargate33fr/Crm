...
namespace Crm.Api.Domain.Search
{
    ...
    public sealed class Pagination
    {
        ...
        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Pagination"/> avec les valeurs par défaut.
        /// See <see cref="NombreElementParDefaut"/> and <see cref="IndexParDefaut"/>.
        /// </summary>
        public Pagination() : this(IndexParDefaut, NombreElementParDefaut) { }

        /// <summary>
        /// Initialise une nouvelle instance de <see cref="Pagination" />.
        /// </summary>
        /// <param name="index">L'index de la page.</param>
        /// <param name="limite">Le nombre maximum d'élément.</param>
        public Pagination(int index, int limite)
        {
            Index = index;
            Limite = limite;
        }
